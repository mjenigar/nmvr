...
class Simulator(Node, threading.Thread):
    ...
    def run(self):
        ...
        # Entry(self.root, textvariable=self.goal_pose_str["x"], width=5).place(x=1050, y=310)
        ...
        # Entry(self.root, textvariable=self.goal_pose_str["y"], width=5).place(x=1050, y=310)
